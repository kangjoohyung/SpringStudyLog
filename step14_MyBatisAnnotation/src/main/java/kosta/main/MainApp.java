...
//		System.out.println("\n4. 사원 등록하기(insert)-------");
//		dao.insert(new EmpDTO(9223, "나미", "백조", 2500, null));
...
//		dao.delete(8001);
		...
		System.out.println("\n5. if문 동적쿼리-----");
//		dao.ifTest(null);//전체검색
//		//하나씩 테스트하기
//		dao.ifTest(new EmpDTO(0, "KING", null, 0, null)); //ename만 입력
		dao.ifTest(new EmpDTO(0, null, "MANAGER", 0, null)); //job만 입력
//		dao.ifTest(new EmpDTO(0, "KING", "MANAGER", 0, null)); //ename + job
		///////////////////
