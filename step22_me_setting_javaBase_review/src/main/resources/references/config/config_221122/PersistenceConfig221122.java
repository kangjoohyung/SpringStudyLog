package references.config.config_221122;
...
public class PersistenceConfig221122  implements TransactionManagementConfigurer{//<tx:annotation-driven
	...
	public SqlSessionFactoryBean getSqlSessionFactoryBean() throws IOException {
		...
		factoryBean.setTypeAliasesPackage("kosta.mvc.model.vo");//클래스의 첫글자만 소문자로 별칭 사용
